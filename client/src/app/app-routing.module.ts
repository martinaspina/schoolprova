...
import { ExameEditComponent} from './pages/exame-edit/exame-edit.component';
...
const routes: Routes = [
    ...
    { path: 'exames/:id',  loadChildren: './pages/exame-edit/exame-edit.module#ExameEditModule' , canActivate: [AuthGuard] },
    { path: 'exames',  loadChildren: './pages/exame-list/exame-list.module#ExameListModule' , canActivate: [AuthGuard] },
